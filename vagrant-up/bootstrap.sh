...
then
    ...
    # TODO: xdebug wird nicht korrekt eingebunden in php, pcntl gibt warning aus "module pcntl already loaded in unknown on line 0"
    # TODO: mysqldump funktioniert nur wenn man für root kein password angibt, WIESO?
    ...
    # TODO bower wird innerhalb dieses scripts nicht korrekt installiert und ist nachher nicht über den befehl `bower` aufrufbar, wenn man denselben befehl aber nach dem start nochmal ausführt wird es korrekt installiert
